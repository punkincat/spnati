namespace SPNATI_Character_Editor
{
	partial class SettingsSetup
	{
		...
		private void InitializeComponent()
		{
			...
			this.recResponder = new Desktop.CommonControls.RecordField();
			this.lblResponder = new Desktop.Skinning.SkinnedLabel();
        ...
        "m to auto-open an alternate costume.");
			...
			this.tabDialogue.Controls.Add(this.recResponder);
			this.tabDialogue.Controls.Add(this.lblResponder);
			...
			// recResponder
			// 
			this.recResponder.AllowCreate = false;
			this.recResponder.Location = new System.Drawing.Point(119, 190);
			this.recResponder.Name = "recResponder";
			this.recResponder.PlaceholderText = null;
			this.recResponder.Record = null;
			this.recResponder.RecordContext = null;
			this.recResponder.RecordFilter = null;
			this.recResponder.RecordKey = null;
			this.recResponder.RecordType = null;
			this.recResponder.Size = new System.Drawing.Size(150, 20);
			this.recResponder.TabIndex = 35;
			this.recResponder.UseAutoComplete = false;
			this.recResponder.RecordChanged += new System.EventHandler<Desktop.CommonControls.RecordEventArgs>(this.recResponder_RecordChanged);
			// 
			// lblResponder
			// 
			this.lblResponder.AutoSize = true;
			this.lblResponder.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this.lblResponder.ForeColor = System.Drawing.SystemColors.ControlText;
			this.lblResponder.Highlight = Desktop.Skinning.SkinnedHighlight.Normal;
			this.lblResponder.Level = Desktop.Skinning.SkinnedLabelLevel.Normal;
			this.lblResponder.Location = new System.Drawing.Point(19, 192);
			this.lblResponder.Name = "lblResponder";
			this.lblResponder.Size = new System.Drawing.Size(94, 13);
			this.lblResponder.TabIndex = 34;
			this.lblResponder.Text = "Default responder:";
			// 
			// chkAutoFill
			// 
