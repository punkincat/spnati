...
npm ci
./node_modules/.bin/babel js --out-dir .public/js --copy-files --source-maps inline --ignore "js/fileIndex.js","js/core-js*","js/fetch.js","js/unorm.js","js/bootstrap*","js/jquery*","js/pako*.js","js/js.cookie.js","js/ResizeObserver.js","js/sentry*.js"
