...
var CANDY_LIST = [
    ...
    "bobobo/0-pumped.png",                 // High Roster Position
    "bobobo/0-aside.png",
    ...
    "sakura/1-smile.png",
    "sakura/2-sing.png",
    "stocking/0-sipp.png",                 // High Roster Position
    "stocking/2-hex.png",
    ...
    "meia/3-happy.png",
    "jura/0-seductive.png",                // Highlighted New Character
    "jura/1-teasing.png",
...
/*
    ...
    "kazuma/3-smirk.png",
    "critical_darling/0-portrait.png",
